function ElizaBot (noRandomFlag = false) {
	this.elizaInitials = eliza.initials;
	this.elizaKeywords = eliza.keywords;
	this.elizaPostTransforms = eliza.posttransforms;
	this.elizaFinals = eliza.finals;
	this.elizaQuits = eliza.quits;
	this.elizaPres = eliza.pres;
	this.elizaPosts = eliza.posts;
	this.elizaSynons = eliza.synons;
